"""
URL configuration for loading_coding project.
...
from loading_coding import settings
from articles.sitemaps import PostSitemap, CategorySitemap
...
admin.site.index_title = "Статьи по программированию"
